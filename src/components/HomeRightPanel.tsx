    ...
    <aside className="w-80 flex flex-col gap-4 shrink-0 h-full overflow-y-auto pr-1 select-none">
      ...
      <div className="bg-white rounded-3xl p-5 border border-purple-100 shadow-xs">
        <div className="flex items-center justify-between mb-3">
          ...
          <button className="text-[11px] font-black text-purple-600 hover:text-purple-800 cursor-pointer hover:underline">
            Edit Goal
          </button>
        </div>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-3 border border-purple-100 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-[10px] text-purple-600 font-bold">Keep going, you can do it!</div>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-50 rounded-3xl p-5 border border-blue-100 shadow-xs relative overflow-hidden">
